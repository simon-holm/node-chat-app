  ...
  renderMessages = () => {
    return this.state.messages.map((message, index) => {
      ...
      if (message.url) {
        ...
        return (
          <div key={index}>
            {from}: {user} shared their{' '}
            <a href={url} target="_blank">
              location
            </a>{' '}
            ({dateParser.timeSince(createdAt)})
          </div>
        )
      }
    })
  ...
  render() {
    ...
    return (
      <Draggable
        ...
        {...dragHandlers}
        defaultPosition={{
          x: randomPosition(45, 800),
          y: randomPosition(25, 200)
        }}
      >
        <div
        ...
        >
            ...
            <div className="terminal-top-bar">
              <div className="controls-group">
                <div className="left-group">
                  <a onClick={this.props.close} className="delete" />
                </div>
          ...
          <div className="chat-screen" onClick={this.focusInput}>
            ...
            >
              <div style={{ marginTop: this.state.topSpace }} />
              {this.renderMessages()}
            </div>
